 ...
 * @file: This is for the name of the file buffer is storing chars for.
 *
 ...
 * @argc: This is for the number of arguments supplied to the program.
 * @argv: This is an array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
 * Description: All these are if at the begining:
