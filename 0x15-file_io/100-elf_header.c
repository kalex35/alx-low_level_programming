 ...
 *
 * Description: This explains if the file is not an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_type - this is meant to print Print the type of an ELF header.
 ...
 * @e_ident: This itself is a pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * @elf: This is a file descriptor of the ELF file.
 *
 ...
 * @argc: This describes the number of arguments supplied to the program.
 * @argv: This is for an array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
